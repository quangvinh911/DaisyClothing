          ...
          <div className={styles.postDetail__products}>
            ...
            <div className={styles.postDetail__productsGrid}>
              {post.products.map(({ product }) => {
                const pImageUrl = getAssetUrl(product.imageUrl);

                // Backend affiliate redirect
                ...
                return (
                  <div key={product.id} className={styles.productCard}>
                    <div className={styles.productCard__image}>
                      {pImageUrl ? (
                        <img src={pImageUrl} alt={product.name} />
                      ) : (
                        <div
                          style={{
                            width: "100%",
                            height: "100%",
                            background: "linear-gradient(135deg, #FAF7F2 0%, #E8D5C4 100%)",
                          }}
                        />
                      )}
                    </div>
                    <div className={styles.productCard__body}>
                      ...
                      <div className={styles.productCard__footer}>
                        ...
                        <a
                          ...
                          className={styles.productCard__buyBtn}
                        >
                          Mua Ngay
                        </a>
                      </div>
